...
public class AdminRemoveStudentController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		int curProfessorID = Integer.parseInt(req.getParameter("studentID"));

		boolean isValidStudentID = Student.isValidStudentID(curProfessorID);
		if (!isValidStudentID) {
			// return error
		}

		Student.removeStudentFromTable(curProfessorID);
